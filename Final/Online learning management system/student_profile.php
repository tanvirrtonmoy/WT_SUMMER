...
<head>
    ...
    <style>
        ...
        .profile-card img {width: 120px; height: 120px; border-radius: 50%; border: 3px solid #3498db; margin-bottom: 15px; cursor: pointer;}
        ...
        .btn {background: #3498db; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; margin-top: 10px; cursor: pointer;}
...
<body>
    <div class="profile-card">
        ...
        <form method="POST" enctype="multipart/form-data">
            <img src="<?php echo !empty($user['profile_image']) ? $user['profile_image'] : 'assets/default.png'; ?>" 
                 id="profilePreview" alt="Profile Image" 

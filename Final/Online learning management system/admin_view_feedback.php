...
$sql = "SELECT id, student_name, student_email, course, rating, message, created_at 
...
<head>
    ...
    <style>
        ...
        .rating { color: gold; font-size: 16px; }
        .delete-btn {
...
<div class="container">
    ...
    <?php else: ?>
        <p style="text-align:center; color:red;">❌ No feedback submitted yet.</p>
    <?php endif; ?>
